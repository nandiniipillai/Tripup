...
function LogExpenseForm() {
  ...
  const initial = useMemo(() => {
    ...
    // scenario's actual Food/Wine split pre-filled — Jules sits this dinner
    // out entirely (not on Food or Wine), Nic and Ren are on Food but not
    // Wine — instead of leaving arbitrary blanks nobody can reproduce the
    // hi-fi numbers from. See scripts/verify-settle-flow.ts for the locked
    // ledger these numbers reproduce.
